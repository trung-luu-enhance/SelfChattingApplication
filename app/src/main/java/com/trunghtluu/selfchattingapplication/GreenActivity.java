...
public class GreenActivity extends AppCompatActivity {
    ...
    private ImageView green_image_view;
    ...
    private String imageUrl = "https://cdn.dribbble.com/users/1787323/screenshots/4458591/dribbbe_bulbasaur-01.png";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        green_image_view = findViewById(R.id.green_image_view);
        Glide.with(this)
                .load(imageUrl)
                .apply(RequestOptions.circleCropTransform())
                .into(green_image_view);
        ...
        chatbox_send_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String message = Constants.GREEN_NAME + ": "
